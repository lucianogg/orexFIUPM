...
This is the general calendar but note that each undergraduate  programme may have its own one, especially in spring semester.
Please check the specific programme in advance.
...
*** Master programmes
This is the general calendar but note that each master programme could have its own one, especially in spring semester.
Please check the specific programme in advance.
