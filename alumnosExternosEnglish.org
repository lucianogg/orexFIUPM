...
* Accommodation
Unfortunately, the ETSIINF does not provide any kind of accommodation facilities for the students, but you can find information for accommodation both at UPM website and in our manual [[https://docs.google.com/document/d/1y13X3u4V8KQgI5hv8GnLGF3ySWQzCl3LcOe14AQKbXk/edit?usp=sharing]["Student Life in Madrid from the very beginning"]].

Note that Madrid is a very expensive city to live, which means that you have to reckon an estimated amount of 350€ per month for a room in a shared flat, and an additional amount as a down payment, which usually serves as guarantee of payment for the landlords. Note that prices can vary significantly depending on the area.

Although the school doesn't have any kind of facility for accommodating incoming exchange students, there is an agreement between the school and the [[https://residenciamonteprincipe.com/][university house Montepríncipe]] which allows students to enjoy a 5% discount over the full charge.
