...
Para información sobre la realización del Trabajo de Fin de Grado en una estancia en otra Universidad, consulte [[#tfgProgMov][la sección dedicada a ello]].
...
:END:
* Realización del Trabajo de Fin de Grado en Programas de Movilidad
:PROPERTIES:
:CUSTOM_ID: tfgProgMov
:END:
Algunos programas de movilidad posibilitan a los alumnos desarrollar su Trabajo de Fin de Grado (TFG) como parte del programa. Esta posibilidad está regulada por la ETSIINF y se pueden consultar las normas en [[http://fi.upm.es/docs/estudios/estudiar_en_el_extranjero/2349_TFG-movilidad-normas%20y%20procedmiento-ABRIL-2016.pdf][este documento]].
